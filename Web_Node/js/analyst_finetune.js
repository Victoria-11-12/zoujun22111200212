...
async function previewData() {
    ...
    try {
        ...
        const response = await fetch(`http://43.111.237.98:3000/api/analyst/preview?${params.toString()}`);
...
async function exportJsonl() {
    ...
    try {
        ...
        const response = await fetch(`http://43.111.237.98:3000/api/analyst/export?${params.toString()}`);
